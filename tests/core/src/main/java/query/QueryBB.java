...
//Various counters for query usage statistics.
public static int NUM_QUERY_EXECS;
public static int TOTAL_QUERY_EXEC_TIME;
public static int NUM_QUERY_EXECS_ATOMIC_COUNTER_SUM;
public static int NUM_QUERY_EXEC_STATS;
public static int TOTAL_QUERY_EXEC_TIME_STATS;
public static int TOTAL_INDEX_COUNT;
public static int NUM_REGION_OPS;
...
public static void HydraTask_initialize() {
   hydra.blackboard.SharedCounters counters = getBB().getSharedCounters();
