 ...
 * Same as hct.BridgeEventListener, but establishes the LogWriter in a static block
 *
 * @author lhughes
 * @since 7.0
 */
public class CSLogListener extends hct.BridgeEventListener implements Declarable {
