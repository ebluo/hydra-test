 ...
 */
public class TTLLocalInvalBB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "TTLLocalInvalBB_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static TTLLocalInvalBB bbInstance = null;
...
/**
 *  Get the TTLLocalInvalBB
 */
public static TTLLocalInvalBB getBB() {
   if (bbInstance == null) {
      synchronized ( TTLLocalInvalBB.class ) {
         if (bbInstance == null) 
            bbInstance = new TTLLocalInvalBB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public TTLLocalInvalBB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public TTLLocalInvalBB(String name, String type) {
   super(name, type, TTLLocalInvalBB.class);
}
