 ...
 */
public class IdleTOLocalInvalBB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "IdleTOLocalInvalBB_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static IdleTOLocalInvalBB bbInstance = null;
...
/**
 *  Get the IdleTOLocalInvalBB
 */
public static IdleTOLocalInvalBB getBB() {
   if (bbInstance == null) {
      synchronized ( IdleTOLocalInvalBB.class ) {
         if (bbInstance == null)  
            bbInstance = new IdleTOLocalInvalBB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public IdleTOLocalInvalBB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public IdleTOLocalInvalBB(String name, String type) {
   super(name, type, IdleTOLocalInvalBB.class);
}
