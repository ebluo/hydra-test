 ...
 */
public class TTLDestroyBB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "TTLDestroyBB_Blackboard";
static String BB_TYPE = "RMI";

// singleton blackboard 
private static TTLDestroyBB bbInstance = null;
...
/**
 *  Get the TTLDestroyBB
 */
public static TTLDestroyBB getBB() {
   if (bbInstance == null) {
      synchronized ( TTLDestroyBB.class ) {
         if (bbInstance == null) 
            bbInstance = new TTLDestroyBB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public TTLDestroyBB(String name, String type) {
   super(name, type, TTLDestroyBB.class);
}
