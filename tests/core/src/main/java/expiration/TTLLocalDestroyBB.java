 ...
 */
public class TTLLocalDestroyBB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "TTLLocalDestroyBB_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static TTLLocalDestroyBB bbInstance = null;
...
/**
 *  Get the TTLLocalDestroyBB
 */
public static TTLLocalDestroyBB getBB() {
   if (bbInstance == null) {
      synchronized ( TTLLocalDestroyBB.class ) {
         if (bbInstance == null) 
            bbInstance = new TTLLocalDestroyBB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public TTLLocalDestroyBB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public TTLLocalDestroyBB(String name, String type) {
   super(name, type, TTLLocalDestroyBB.class);
}
