 ...
 */
public class TTLInvalBB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "TTLInvalBB_Blackboard";
static String BB_TYPE = "RMI";

// single instance of blackboard
private static TTLInvalBB bbInstance = null;
 ...
 *  Get the TTLInvalBB
 */
public static TTLInvalBB getBB() {
   if (bbInstance == null) {
      synchronized ( TTLInvalBB.class ) {
         if (bbInstance == null) 
            bbInstance = new TTLInvalBB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public TTLInvalBB(String name, String type) {
   super(name, type, TTLInvalBB.class);
}
