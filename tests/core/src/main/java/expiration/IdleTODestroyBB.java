 ...
 */
public class IdleTODestroyBB extends Blackboard {
...
private static IdleTODestroyBB bbInstance = null;
...
/**
 *  Get the IdleTODestroyBB
 */
public static IdleTODestroyBB getBB() {
   if (bbInstance == null) {
      synchronized ( IdleTODestroyBB.class ) {
        if (bbInstance == null) 
          bbInstance = new IdleTODestroyBB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public IdleTODestroyBB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public IdleTODestroyBB(String name, String type) {
   super(name, type, IdleTODestroyBB.class);
}
