 ...
 */
public class IdleTOInvalBB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "IdleTOInvalBB_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static IdleTOInvalBB bbInstance = null;
...
/**
 *  Get the IdleTOInvalBB
 */
public static IdleTOInvalBB getBB() {
   if (bbInstance == null) {
      synchronized ( IdleTOInvalBB.class ) {
         if (bbInstance == null) 
            bbInstance = new IdleTOInvalBB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public IdleTOInvalBB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public IdleTOInvalBB(String name, String type) {
   super(name, type, IdleTOInvalBB.class);
}
