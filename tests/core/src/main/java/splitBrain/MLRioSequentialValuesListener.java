...
/** MLRio SequentialValues Listener. 
 ...
 *  MLRioBB.  (Only the first failure is written to the blackboard).
 *
 ...
 * @since 5.5
 */
public class MLRioSequentialValuesListener extends util.AbstractListener implements CacheListener, Declarable {
