 ...
 */
public class GemFireRollbackListener extends util.AbstractListener implements TransactionListener {

/** Called after a successful commit of a transaction: logs event.
 *
...
public void afterCommit(TransactionEvent event) {
  ...
  // database commit is done in GemFireTxWriter (beforeCommit())

}

/** Called after an explicit rollback of a transaction: logs event,
 *  rollsback data base operations.
 *
 * @param event the TransactionEvent
 */
...
/** Called after an unsucessful commit operation: logs event,
 *  rollsback data base operations.
 *
 * @param event the TransactionEvent
 */
 ...
 */
public void close() {
  Log.getLogWriter().info("GemFireRollbackListener: close()");
}
