 ...
 */
public class TxListener extends util.AbstractListener implements TransactionListener {
...
private void validate(String txAction, TransactionEvent txEvent) {
  Log.getLogWriter().fine("TxListener: validate() invoked with TxEvent " + txEvent.toString());
