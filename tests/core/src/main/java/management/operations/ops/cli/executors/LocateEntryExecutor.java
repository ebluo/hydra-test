...
public class LocateEntryExecutor extends AbstractTestCommandExecutor {
 ...
 */
  ...
  protected void fillOption(TestCommandInstance instance, CommandOption op) {
    if(CliStrings.LOCATE_ENTRY__RECURSIVE.equals(op.name)){
