...
public class ShutDownExecutor extends AbstractTestCommandExecutor {
 ...
 */
  ...
  protected void fillOption(TestCommandInstance instance, CommandOption op) {
    if(CliStrings.SHUTDOWN__TIMEOUT.equals(op.name)){
      String timeout = ""+HydraUtil.getnextRandomInt(10);
      instance.addOption(op.name, timeout);
    }
  }
