...
public class StatusGWReceiverExecutor extends AbstractTestCommandExecutor {
 ...
 */  
  ...
  protected void fillMandatoryOption(TestCommandInstance instance, String name) {
    if(CliStrings.STATUS_GATEWAYRECEIVER__GROUP.equals(name)){
      instance.addOption(name, getGroupsNoManaging());
    }else if(CliStrings.STATUS_GATEWAYRECEIVER__MEMBER.equals(name)){
