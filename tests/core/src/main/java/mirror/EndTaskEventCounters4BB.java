...
static String BB_NAME = "EndTaskEventCounters4_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EndTaskEventCounters4BB bbInstance = null;
...
/**
 *  Get the EndTaskEventCounters4BB
 */
public static EndTaskEventCounters4BB getBB() {
   if (bbInstance == null) {
      synchronized ( EndTaskEventCounters4BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EndTaskEventCounters4BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EndTaskEventCounters4BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EndTaskEventCounters4BB(String name, String type) {
   super(name, type, EndTaskEventCounters4BB.class);
}
