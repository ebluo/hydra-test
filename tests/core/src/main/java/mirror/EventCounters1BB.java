...
public class EventCounters1BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EventCounters1_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EventCounters1BB bbInstance = null;
...
/**
 *  Get the EventCounters1BB
 */
public static EventCounters1BB getBB() {
   if (bbInstance == null) {
      synchronized ( EventCounters1BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EventCounters1BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EventCounters1BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EventCounters1BB(String name, String type) {
   super(name, type, EventCounters1BB.class);
}
