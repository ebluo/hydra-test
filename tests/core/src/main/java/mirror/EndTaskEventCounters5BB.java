...
public class EndTaskEventCounters5BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EndTaskEventCounters5_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EndTaskEventCounters5BB bbInstance = null;
...
/**
 *  Get the EndTaskEventCounters5BB
 */
public static EndTaskEventCounters5BB getBB() {
   if (bbInstance == null) {
      synchronized ( EndTaskEventCounters5BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EndTaskEventCounters5BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EndTaskEventCounters5BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EndTaskEventCounters5BB(String name, String type) {
   super(name, type, EndTaskEventCounters5BB.class);
}
