...
public class EventCounters5BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EventCounters5_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EventCounters5BB bbInstance = null;
...
/**
 *  Get the EventCounters5BB
 */
public static EventCounters5BB getBB() {
   if (bbInstance == null) {
      synchronized ( EventCounters5BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EventCounters5BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EventCounters5BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EventCounters5BB(String name, String type) {
   super(name, type, EventCounters5BB.class);
}
