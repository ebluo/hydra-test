...
public class EndTaskEventCounters6BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EndTaskEventCounters6_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EndTaskEventCounters6BB bbInstance = null;
...
/**
 *  Get the EndTaskEventCounters6BB
 */
public static EndTaskEventCounters6BB getBB() {
   if (bbInstance == null) {
      synchronized ( EndTaskEventCounters6BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EndTaskEventCounters6BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EndTaskEventCounters6BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EndTaskEventCounters6BB(String name, String type) {
   super(name, type, EndTaskEventCounters6BB.class);
}
