...
public class EventCounters3BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EventCounters3_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EventCounters3BB bbInstance = null;
...
/**
 *  Get the EventCounters3BB
 */
public static EventCounters3BB getBB() {
   if (bbInstance == null) {
      synchronized ( EventCounters3BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EventCounters3BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EventCounters3BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EventCounters3BB(String name, String type) {
   super(name, type, EventCounters3BB.class);
}
