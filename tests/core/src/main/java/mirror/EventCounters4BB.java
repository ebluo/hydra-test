...
public class EventCounters4BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EventCounters4_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EventCounters4BB bbInstance = null;
...
/**
 *  Get the EventCounters4BB
 */
public static EventCounters4BB getBB() {
   if (bbInstance == null) {
      synchronized ( EventCounters4BB.class ) {
        if (bbInstance == null) 
           bbInstance = new EventCounters4BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EventCounters4BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EventCounters4BB(String name, String type) {
   super(name, type, EventCounters4BB.class);
}
