...
public class EventCounters2BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EventCounters2_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EventCounters2BB bbInstance; 
...
/**
 *  Get the EventCounters2BB
 */
public static EventCounters2BB getBB() {
   if (bbInstance == null) {
      synchronized ( EventCounters2BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EventCounters2BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EventCounters2BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EventCounters2BB(String name, String type) {
   super(name, type, EventCounters2BB.class);
}
