...
public class EndTaskEventCounters1BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EndTaskEventCounters1_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EndTaskEventCounters1BB bbInstance = null;
...
/**
 *  Get the EndTaskEventCounters1BB
 */
public static EndTaskEventCounters1BB getBB() {
   if (bbInstance == null) {
      synchronized ( EndTaskEventCounters1BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EndTaskEventCounters1BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EndTaskEventCounters1BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EndTaskEventCounters1BB(String name, String type) {
   super(name, type, EndTaskEventCounters1BB.class);
}
