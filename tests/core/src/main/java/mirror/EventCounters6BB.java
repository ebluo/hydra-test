...
public class EventCounters6BB extends Blackboard {
   
// Blackboard variables
static String BB_NAME = "EventCounters6_Blackboard";
static String BB_TYPE = "RMI";

// singleton instance of blackboard
private static EventCounters6BB bbInstance = null;
...
/**
 *  Get the EventCounters6BB
 */
public static EventCounters6BB getBB() {
   if (bbInstance == null) {
      synchronized ( EventCounters6BB.class ) {
         if (bbInstance == null) 
            bbInstance = new EventCounters6BB(BB_NAME, BB_TYPE);
      }
   }
   return bbInstance;
}
 ...
 */
public EventCounters6BB() {
}
   
/**
 *  Creates a sample blackboard using the specified name and transport type.
 */
public EventCounters6BB(String name, String type) {
   super(name, type, EventCounters6BB.class);
}
