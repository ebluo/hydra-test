 ...
 * @since 4.0
 */
public class Position implements ConfigurableObject, Declarable, Serializable, Comparable {
  ...
  public void validate (int index){
    if ((int)this.qty != index) {
      throw new ObjectValidationException("validation fails");
    }
  }
